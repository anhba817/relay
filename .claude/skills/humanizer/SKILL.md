...
Replace all curly quotes with straight quotes in output text.
...
>
> The update improves the interface, speeds up load times through improved training, contributing to higher standards.
>
