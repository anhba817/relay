...
FOREIGN: set[tuple[str, str]] = {
    ...
    # doctrine at the top of this file is that an unrecognised foreign id FAILS rather
    # than being pattern-matched past. Clearing it is a step, not an oversight, and this
