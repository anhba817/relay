...
- [ ] T056c Record in the same page that `docs_url` **remains a placeholder** (FR-047). This chapter ships the first error code a developer will receive routinely and want to look up; constitution V requires every code have a reachable page; none exists, and a docs site is not this chapter's to build. State the gap rather than let the URL imply otherwise
