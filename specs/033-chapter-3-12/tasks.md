...
- [ ] T126 **All three repositories committed, tagged, and pushed with the parent's pins last.** The earlier note read: Pushing is outward-facing and would put a red `check:fences` on the default branch. Held for the same reason as T125, and because the decision belongs to the person whose branch it is
