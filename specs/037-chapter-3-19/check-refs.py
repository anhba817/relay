...
FOREIGN = {
    ("spec.md", "T065"): "chapter 3.18's close-out task",
    ("quickstart.md", "T065"): "chapter 3.18's close-out task",
    ("plan.md", "T086"): "chapter 3.18's phase task, in the replaced-check warning",
}
