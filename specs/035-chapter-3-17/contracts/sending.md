...
| application key | a **person** of this tenant | **403** `forbidden` — a key may not post as a person |
...
list their own users. Refusing with 403 reveals nothing they did not have, and it names the
rule: *this credential may not post as a person.* A client that gets 400 there would go looking
