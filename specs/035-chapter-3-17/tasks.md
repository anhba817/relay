...
- [ ] T002 Add `FR-MSG-15` to `docs/04-srs.md` §4.5: every message shall carry a sender; a message sent with an application credential shall name a bot user of that tenant. P1, verification `T` (FR-015)
