...
- [ ] T067 Run `pnpm coverage` and confirm every per-file ratchet holds, and that the three new entries T033b added are met. Where a ratchet moves, record the before and after figures rather than the direction
...
- **Phase 4**: T030, T030a, T031, T032, T033 and T033a are six independent
  ...
  with all of them; T033b and T033d are not — both wait on a coverage run. T023a and T023b are not parallel
