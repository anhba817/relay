...
6. **Breaking a chapter behind this one without noticing.** Two of 4.11's tests assert the
   ...
   them.** T008a.
7. **Believing a green run against a stale build.** Three kinds, and this chapter adds the
