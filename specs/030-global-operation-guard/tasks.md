...
- [X] T016b [US2] **Bait goes to the api and dispatcher lanes only** (FR-022). The gateway and e2e lanes get exemption handling and no bait: neither holds a reader-shape fault, and planting changes a suite's workload for no return — which is the failure research R4 measured
