...
- [ ] T046a [US1] **Add `join` to the oracle** now that T045 has built it: joining a private channel the caller cannot see answers exactly as joining one that does not exist (SC-001, SC-002) — `services/api/src/isolation/gauntlet.itest.ts`
