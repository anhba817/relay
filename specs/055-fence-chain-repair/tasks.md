...
- [ ] T092 [US2] Run the tutorial job's five other gates, **named from `ci.yml` rather than remembered** (`.github/workflows/ci.yml:184-205`): `pnpm lint`, `pnpm build`, `pnpm check:docs`, `pnpm check:srs`, `pnpm check:figures`. The sixth step is `check:fences`, which T086 covers.
