...
FOREIGN: set[tuple[str, str]] = {
    # Filled one pair at a time as a record names what a task does. Chapter 3.21
    # ended with nineteen. Each of these is a sentence a reader needs — "T041a
    # carries the fix" beats "a task in phase five".
    ("research.md", "T041a"),
    ("research.md", "T056"),
    ("research.md", "T056a"),
    ("research.md", "T072"),
    # Phase 1 amended R11b: the red test needs the module in a second fixture.
    ("research.md", "T011"),
    ("research.md", "T042d"),
    ("plan.md", "T041"),
    ("plan.md", "T042"),
    ...
    ("plan.md", "T080"),
    ("plan.md", "T090"),
    # The structure block's annotations, added in pass 11: naming which task
    # touches each file is the whole point of the block, so these are declared
    ...
    ("data-model.md", "T031"),
    ("data-model.md", "T041a"),
    ("checklists/requirements.md", "T041a"),
    ("checklists/requirements.md", "T056"),
    ("checklists/requirements.md", "T056a"),
    ("checklists/requirements.md", "T072"),
    ("checklists/requirements.md", "T073a"),
    # The FR-011b coverage row, added in pass 7 and caught by this checker in pass 8.
    ("checklists/requirements.md", "T030a"),
    ("checklists/requirements.md", "T040a"),
    ("checklists/requirements.md", "T056b"),
    ("checklists/requirements.md", "T056c"),
}
...
def main() -> int:
    ...
    for n, line in enumerate(tasks_file.read_text().split("\n"), 1):
        ...
        m = TASK.match(line)
        if not m:
            problems.append(f"tasks.md:{n} does not match the checklist format")
            continue
