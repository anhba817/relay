...
741 subscriptions name `channel.created`. Under the rule above, all 741 remain valid. No row
is rewritten. Under the rule the review recommends, all 741 would become invalid — which is
the measurement that changed this contract.
