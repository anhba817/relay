...
- [ ] T045 [US4] Discharge **FR-012** and **SC-009**: **plant matched totals on both sides at volume, in the lane** — N tenant-periods where the analytical and operational figures agree exactly — then measure **the smallest drift the 0.1% threshold detects at that N**. §2.3 asks for *"the 0.1% figure, at a volume where 0.1% is a real threshold"*, and that is a claim about resolution rather than about agreement.
